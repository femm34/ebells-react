import "./ProductTypesManager.css";
...
export default function ProductTypesManager() {
  ...
  return (
    <div className="upload-portfolio">
      <Card>
        <CardBody>
          <h1 className="upload-portfolio-title">Categorias de producto.</h1>
          <div className="upload-portfolio-card">
            <p className="upload-portfolio-text">Administra tus categorias.</p>
